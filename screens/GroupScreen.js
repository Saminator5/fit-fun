          ...
          <Card style={{minHeight: 100, marginRight: 2, marginLeft: 2}}>
            <CardItem>
              <View style={{flexDirection: 'row'}}>
                <View style={{flex: 1}}>
                  <Image style={{width: 80, height: 80, borderRadius: 40}} source={{uri: 'https://img.huffingtonpost.com/asset/56f30663150000ad000b3082.jpeg?cache=c15cnysyem&ops=scalefit_960_noupscale'}} />
                </View>
                <View style={{flex: 3, flexDirection: 'column'}}>
                  <Text style={{fontWeight: 'bold'}}>Nike Running</Text>
                  <Text style={{fontSize: 15, color: '#292929'}} note>San Francisco runners come join us! We are always open to people blaha awdhw ewadih ewahdi waohe ehoeuw ewuhoe</Text>
                </View>
              </View>
            </CardItem>
          </Card>
